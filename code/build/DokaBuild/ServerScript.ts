...
(function() {
    ...
    loader
         ...
         */
        .setStaticPath("code/build/DokaBuild/static")
        /**
         ...
         *      build directory.
         */
        .setSolBuildPath("code/build/DokaBuild/static/sol/build")
        .addContract("Diamond", "code/build/DokaBuild/static/sol/src/native/solidstate/Diamond.sol");
