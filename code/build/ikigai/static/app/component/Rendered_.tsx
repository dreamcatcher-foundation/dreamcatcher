...
import type {EventSubscription} from "../operator/Emitter.ts";
import React, {useState, useEffect} from "react";
import {Link} from "react-router-dom";
import {animated, useSpring, config} from "react-spring";
import {on, post, render, push, swap, pull, wipe, cleanup} from "../operator/Emitter.ts";
            ...
            on({
                ...
                handler: function() {
                    ...
                    for (let i = 0; i < componentsLength; i++) {
                        const componentsNow: (React.JSX.Element)[] = onScreen;
                        componentsNow.pop();
