...
import {defaultMappedEventEmitter} from "../toolkit/Toolkit.ts";
...
class Base {
    public static Component(props: BaseProps): ReactNode {
        const {name: pName, className: pClassName, style: pStyle, spring: pSpring, springConfig: pSpringConfig, mountDelay, mountCooldown, children, ...more} = props;
        ...
        const name: string = pName ?? uniqueString();
        useEffect(function() {
