...
function Engine(
    ...
    function createContractFromDeployedContract(networkId: string, blueprint: string, address: string) {
        return createContract(networkId, material[blueprint]?.ABI()!, address);
    }
    ...
    return {
        ...
        createContract,
        deployContract,
        createContractFromDeployedContract
    }
}
