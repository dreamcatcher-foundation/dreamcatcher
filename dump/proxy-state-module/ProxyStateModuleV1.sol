...
import "contracts/polygon/abstract/access-control/ownable-state/OwnableStateV1.sol";

/**
* @dev Just like ProxyStateBaseV1 but with simple ownable functionality, intended for use
*      in side contracts.
 */
abstract contract ProxyStateModuleV1 is ProxyStateRouterV1, ProxyStateHistoryV1, OwnableStateV1 {
