...
import Navbar from "../component/layout/userInterface/navbar/Navbar.tsx";
import NavbarOption from "../component/layout/userInterface/navbar/NavbarOption.tsx";
import RowHook from "../component/layout/RowHook.tsx";
...
export default function NavigationLayer(): ReactNode {
    return (
        ...
        style={{
            ...
            <RowHook 
            nodeKey="navigationLayer.topRow"
            style={{
                width: "100%", 
                height: "auto",
                ...
                <Navbar
                nodeKey="navigationLayer.navbar"
                style={{
                    gap: "20px"
                }}>
                    <NavbarOption
