...
export const BLUE: Hex = Hex("#0652FE").unwrap();
export const RED: Hex = Hex("#FF3200").unwrap();
export const DEEP_PURPLE: Hex = Hex("#615FFF").unwrap();
export const DEEP_PURPLE_GRADIENT: Hex[] = [DEEP_PURPLE, Hex("#9662FF").unwrap()];
export const RED_TO_PINK_GRADIENT: Hex[] = [RED, PINK];